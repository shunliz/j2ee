...
import
 com.simos.service.SystemInitService;
...
new
 SpringApplicationBuilder().sources(QuickStartApplication.class)
            .listeners(
new
 SimosApplicationListener()).run(args);
}
}
...
![](https://upload-images.jianshu.io/upload_images/6566116-63cf043d78f6bce0.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/868/format/webp)
